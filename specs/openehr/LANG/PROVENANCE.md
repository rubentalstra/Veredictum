...
- Ref: Release-1.0.0
- Commit: `096932fc6c8fb90f7e5bb52f1a118b4a0234e916`
...
- Plus the 19 UML class-diagram SVG(s) under `docs/UML/diagrams/` that
...
- Plus the 33 per-document figure(s) under
