...
image::{uml_diagrams_uri}/LANG-bmm3.core-class.svg[id=core_class, align="center"]
...
image::{uml_diagrams_uri}/LANG-bmm3.core.range_constrained.svg[id=core_range_constrained, align="center"]
