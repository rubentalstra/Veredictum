...
catalogue of 1116 case cores and 247 operation bindings that passes every
...
implementation is this repository's published instrument (1116 case cores,
...
- Our instrument: this repository (`app/veredictum/`), published as
  ...
  re-verification); the catalogue holds 1116 case cores and 247 operation
