...
//!
//! Every instrument is a subcommand. `veredictum --help` lists them, and
//! `veredictum <subcommand> --help` documents one; the book's command
//! reference is that output rendered per subcommand, with the notes behind
//! each flag beside it.
//!
