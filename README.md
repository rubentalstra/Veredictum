...
<p align="center">
<strong>the released openEHR specifications, version-aware per case</strong> &nbsp;·&nbsp; <strong>1139 spec-cited cases</strong> &nbsp;·&nbsp; <strong>249 operation bindings</strong>
</p>
...
machine-readable catalogue of 1139 test cases. Each case cites the
...
- **The openEHR SEC and the CNF authors:** the
  ...
  P Pazos. 349 of the 1139 case cores here cite one of its Test Schedule
  chapters.
- **Pablo Pazos (CaboLabs):** the fleshed EHR, COMPOSITION, CONTRIBUTION and
  ...
  testing on the community forums for years. 127 of the 1139 case cores cite
